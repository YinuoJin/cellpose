...
def main():
    ...
    training_args.add_argument('--nimg_per_epoch',
                        default=200, type=int, help='number of images (only for training) per epoch. Default: %(default)s')
    ...
    training_args.add_argument('--min_train_masks',
                        default=0, type=int, help='minimum number of masks a training image must have to be used. Default: %(default)s')
    ...
    # DEBUG: optional arguments whether learn cross-slice info on consecutive 2D slices of 3D training data
    training_args.add_argument('--do_cgru',
                        default=0, type=int, help='learn cross-slice info within batch during training')
    training_args.add_argument('--rand_perm', action='store_true', help='perform index random permuataton during training')
